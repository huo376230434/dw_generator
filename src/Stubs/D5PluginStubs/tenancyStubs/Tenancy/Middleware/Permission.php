...
class Permission
{
     ...
     * @var string
     */
    protected $middlewarePrefix = 'tenancy.permission:';
...
//        dd(Tenancy::user()->allPermissions());
        if (!Tenancy::user()->allPermissions()->first(function ($permission) use ($request) {
