...
class DwMakeBtpModal extends Command
{
     ...
     * @var string
     */
    protected $signature = 'dm:bt3pmodal  {modal_name} {--model=}  {--admin}';
...
//      \$data = \$query->paginate(10);
        ...
        \$data = [];
        return jsonSuccess(view('admin.custom.bt3modals.{$this->snake_modal_name}.{$this->snake_modal_name}_piece', [
            'params' => \$data,
...
//            $this->warn($method . " " . $model . "已经存在");
    ...
    private function init_configs()
    {
        ...
        $this->stub_dir = $this->getBaseStubDir().'/btp3_modalStubs/';

        $this->modal_class_dir = app_path("Admin/Extensions/BaseExtends/Widgets/Bt3Modals/");
        $this->modal_blade_dir = resource_path("views/admin/custom/bt3modals/");
